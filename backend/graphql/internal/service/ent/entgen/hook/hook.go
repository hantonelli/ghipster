...
type ProductFunc func(context.Context, *entgen.ProductMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f ProductFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	mv, ok := m.(*entgen.ProductMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.ProductMutation", m)
	}
	return f(ctx, mv)
}
...
type ReviewFunc func(context.Context, *entgen.ReviewMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f ReviewFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	mv, ok := m.(*entgen.ReviewMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.ReviewMutation", m)
	}
	return f(ctx, mv)
}
