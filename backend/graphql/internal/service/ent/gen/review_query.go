...
func (rq *ReviewQuery) sqlAll(ctx context.Context) ([]*Review, error) {
	...
	if rq.withAuthor != nil || rq.withProduct != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := rq.withAuthor; query != nil {
		...
		for i := range nodes {
			if fk := nodes[i].user_reviews; fk != nil {
				ids = append(ids, *fk)
	...
	if query := rq.withProduct; query != nil {
		...
		nodeids := make(map[int][]*Review)
		for i := range nodes {
			if fk := nodes[i].product_reviews; fk != nil {
				ids = append(ids, *fk)
				nodeids[*fk] = append(nodeids[*fk], nodes[i])
			}
		}
		...
		for _, n := range neighbors {
			nodes, ok := nodeids[n.ID]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "product_reviews" returned %v`, n.ID)
			}
			for i := range nodes {
...
func (rq *ReviewQuery) sqlExist(ctx context.Context) (bool, error) {
	...
	if err != nil {
		return false, fmt.Errorf("gen: check existence: %v", err)
	}
	return n > 0, nil
}
...
func (rgb *ReviewGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("gen: ReviewGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *ReviewGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{review.Label}
	default:
		err = fmt.Errorf("gen: ReviewGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *ReviewGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("gen: ReviewGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *ReviewGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{review.Label}
	default:
		err = fmt.Errorf("gen: ReviewGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *ReviewGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("gen: ReviewGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *ReviewGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{review.Label}
	default:
		err = fmt.Errorf("gen: ReviewGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *ReviewGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("gen: ReviewGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *ReviewGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{review.Label}
	default:
		err = fmt.Errorf("gen: ReviewGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *ReviewSelect) Scan(ctx context.Context, v interface{}) error {
	...
	rs.sql = rs.ReviewQuery.sqlQuery()
...
func (rs *ReviewSelect) Strings(ctx context.Context) ([]string, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("gen: ReviewSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *ReviewSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{review.Label}
	default:
		err = fmt.Errorf("gen: ReviewSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *ReviewSelect) Ints(ctx context.Context) ([]int, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("gen: ReviewSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *ReviewSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{review.Label}
	default:
		err = fmt.Errorf("gen: ReviewSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *ReviewSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("gen: ReviewSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *ReviewSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{review.Label}
	default:
		err = fmt.Errorf("gen: ReviewSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *ReviewSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("gen: ReviewSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *ReviewSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{review.Label}
	default:
		err = fmt.Errorf("gen: ReviewSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
