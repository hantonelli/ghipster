...
func (uq *UserQuery) QueryReviews() *ReviewQuery {
	query := &ReviewQuery{config: uq.config}
...
func (ugb *UserGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("gen: UserGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("gen: UserGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("gen: UserGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("gen: UserGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("gen: UserGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("gen: UserGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("gen: UserGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("gen: UserGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Strings(ctx context.Context) ([]string, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("gen: UserSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("gen: UserSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Ints(ctx context.Context) ([]int, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("gen: UserSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("gen: UserSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("gen: UserSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("gen: UserSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("gen: UserSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("gen: UserSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
