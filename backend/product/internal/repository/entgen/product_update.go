...
func (pu *ProductUpdate) check() error {
	if v, ok := pu.mutation.Name(); ok {
		if err := product.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`entgen: validator failed for field "Product.name": %w`, err)}
		}
	}
	return nil
}
...
func (puo *ProductUpdateOne) sqlSave(ctx context.Context) (_node *Product, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`entgen: missing "Product.id" for update`)}
	}
