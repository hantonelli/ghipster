...
func (pq *ProductQuery) sqlExist(ctx context.Context) (bool, error) {
	...
	if err != nil {
		return false, fmt.Errorf("entgen: check existence: %v", err)
	}
	return n > 0, nil
}
...
func (pgb *ProductGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: ProductGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *ProductGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{product.Label}
	default:
		err = fmt.Errorf("entgen: ProductGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *ProductGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: ProductGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *ProductGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{product.Label}
	default:
		err = fmt.Errorf("entgen: ProductGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *ProductGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: ProductGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *ProductGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{product.Label}
	default:
		err = fmt.Errorf("entgen: ProductGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *ProductGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: ProductGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *ProductGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{product.Label}
	default:
		err = fmt.Errorf("entgen: ProductGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *ProductSelect) Scan(ctx context.Context, v interface{}) error {
	...
	ps.sql = ps.ProductQuery.sqlQuery()
...
func (ps *ProductSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: ProductSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *ProductSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{product.Label}
	default:
		err = fmt.Errorf("entgen: ProductSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *ProductSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: ProductSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *ProductSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{product.Label}
	default:
		err = fmt.Errorf("entgen: ProductSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *ProductSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: ProductSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *ProductSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{product.Label}
	default:
		err = fmt.Errorf("entgen: ProductSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *ProductSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: ProductSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *ProductSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{product.Label}
	default:
		err = fmt.Errorf("entgen: ProductSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
